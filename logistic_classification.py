...
class LogisticClassification:
    ...
    def fit(self, X, y):
        ...
        for _ in range(self.n_iters):
            ...
            derivative_cost = self.derivative_cost(y, y_pred)
    ...
    def gradient(self, X, y_pred, derivative_cost):
        derivative_weights = (derivative_cost * y_pred * (1 - y_pred)).T @ X
        derivative_bias = np.mean((derivative_cost * y_pred * (1 - y_pred)))
    ...
    def derivative_cost(self, y, y_pred):
